 ...
 * @author User
 */
@WebServlet(name = "AlterarProduto", urlPatterns = {"/alterar_produto.do"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
                ...
                Double preco_un = Double.parseDouble(request.getParameter("preco"));
                ...
                p.setPreco_un(preco_un);
                p.setLink_imagem(link);
